...
TA | [Le Nguyen (Lead)](mailto:le.nguyen@auckland.ac.nz), [Fatemeh Rostambeygi](mailto:fatemeh.rostambeygi@auckland.ac.nz), [Dorian Wang](mailto:wyil819@aucklanduni.ac.nz)
...
## 🥇 Assessment
- A1: due on Week 01 Fri 23:59 (6%)
- A2: due on Week 02 Fri 23:59 (6%)
...
- Software: [Draw.io](https://www.drawio.com), [SQLite](http://sqlite.org), [VS Code](https://code.visualstudio.com) and [Inspera Integrity Browser](https://www.auckland.ac.nz/en/students/academic-information/exams-and-final-results/about-exams/exam-mode-b.html)
...
- Email: Use it for _private message_ only. Direct all administrative matter, marking issue and lab material to the [TA lead](mailto:le.nguyen@auckland.ac.nz); lecture material and assessment question to the [teacher](mailto:jh.chan@auckland.ac.nz)

- Office Hour: Mon 13:00-14:00, by appointment only via email 24 hours prior
